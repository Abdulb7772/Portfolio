...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 md:py-32 bg-gray-100 dark:bg-slate-900">
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill, index) => (
                    <motion.span
                      ...
                      className="px-3 py-1.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-sm font-medium"
                    >
                      {skill}
                    </motion.span>
                  ))}
