  ...
  const experiences = [
    {
      ...
      responsibilities: [
        ...
        "Currently working on a blog website project, implementing features such as blog creation, editing, and listing using Next.js for the frontend and MongoDB as the backend database.",
